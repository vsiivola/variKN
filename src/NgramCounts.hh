...
public:
  ...
  virtual inline ~NgramCounts() { if (m_destruct_vocab) delete vocab;}
  ...
  inline void use_vocabulary(Vocabulary *V) {
    if (m_destruct_vocab) delete vocab;
...
protected:
  ...
  inline long ascii2num(char *c, long *a) {return(strtol(c, NULL, 10));} // FIXME: This can be broken
  ...
  inline float ascii2num(char *c, double *a) {return((float) strtod(c,NULL));}
...
class NgramCounts_t : public NgramCounts{
public:
