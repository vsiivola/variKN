...
public:
  ...
  float log_prob_bo(const std::vector<int> &gram) { throw NotImplemented(); } // backoff, default
  float log_prob_i(const std::vector<int> &gram) { throw NotImplemented(); } // Interpolated

  float log_prob_bo(const std::vector<unsigned short> &gram) { throw NotImplemented(); } // backoff, default
  float log_prob_i(const std::vector<unsigned short> &gram) { throw NotImplemented(); } // Interpolated
